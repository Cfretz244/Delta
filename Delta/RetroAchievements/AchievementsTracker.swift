...
extension AchievementsTracker
{
    func start() async throws
    {
        ...
        case .genesis, .gc, nil: throw AchievementsError(errorCode: AchievementsError.unsupportedSystem, message: NSLocalizedString("System is not yet supported.", comment: ""))
        }
